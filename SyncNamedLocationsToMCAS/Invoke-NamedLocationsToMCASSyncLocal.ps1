...
.DESCRIPTION
    This script is meant to run in locally and will request the follwing info:
...
.EXAMPLE
    ...
    ..\Invoke-NamedLocationsToMCASSyncLocal.ps1

.EXAMPLE
    Change the default logpath with the use of the parameter logPath
    ..\Invoke-NamedLocationsToMCASSyncLocal.ps1 -logPath "C:\Windows\Temp\CustomScripts\Invoke-NamedLocationsToMCASSyncLocal.txt"
...
[string]$MCASUser = Read-Host -Prompt "Specify API URL (without https://)"
